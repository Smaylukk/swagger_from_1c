...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "Swagger";
	Описание.Версия = "1.1.1.5";
	
	
КонецПроцедуры

Процедура ОбновлениеНаВерсию_1113() Экспорт 
	Константы.ВерсияOpenAPI.Установить("3.0.1");
	
	Если Не ЗначениеЗаполнено(Константы.ЗаголовокСистемы.Получить()) Тогда
		Константы.ЗаголовокСистемы.Установить("Swagger from 1C");
	КонецЕсли;
КонецПроцедуры
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура 			= "ОбновлениеИнформационнойБазыSwagger.ОбновлениеНаВерсию_1113";
КонецПроцедуры
