...
Процедура ПослеПроверкиСуществованияКаталога(Существует, ДопПараметры) Экспорт
	Если Существует Тогда
		...
		ДанныеМакета.НачатьЗапись(Новый ОписаниеОповещения("ПослеЗаписиФайлаМакета", РедакторКлиент, ДопПараметры), ИмяФайла);
	Иначе
...
Процедура ПослеСозданияКаталога(ИмяКаталога, ДопПараметры) Экспорт
	...
	ФайлНаДиске.НачатьПроверкуСуществования(Новый ОписаниеОповещения("ПослеПроверкиСуществованияКаталога", РедакторКлиент, ДопПараметры));
КонецПроцедуры

Процедура ПослеПроверкиСуществованияФайла(Существует, ДопПараметры) Экспорт
	Если Не Существует Тогда
		НачатьСозданиеКаталога(Новый ОписаниеОповещения("ПослеСозданияКаталога", РедакторКлиент, ДопПараметры), ДопПараметры.КаталогИсходников);
	Иначе
		ВыполнитьОбработкуОповещения(Новый ОписаниеОповещения("ОбработкаИнициализации", ДопПараметры.Форма, ДопПараметры), Истина);
	КонецЕсли;
КонецПроцедуры
...
Процедура ПриПолученииКаталогаВременныхФайлов(ИмяКаталога, ДопПараметры) Экспорт
	...
	Файл.НачатьПроверкуСуществования(Новый ОписаниеОповещения("ПослеПроверкиСуществованияФайла", РедакторКлиент, ДопПараметры));
КонецПроцедуры
...
Процедура ИзвлечьИсходники(АдресМакета, Форма) Экспорт
	...
	НачатьПолучениеКаталогаВременныхФайлов(Новый ОписаниеОповещения("ПриПолученииКаталогаВременныхФайлов", РедакторКлиент, ДопПараметры));
КонецПроцедуры
