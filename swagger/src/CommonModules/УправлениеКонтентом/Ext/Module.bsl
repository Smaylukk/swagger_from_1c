...
Функция ПолучитьНастройкиЭкспортаОбъекта(ВидОбъекта) Экспорт 
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	НастройкиЭкспортаHtmlОбъектов.HtmlОбъект КАК HtmlОбъект,
	|	НастройкиЭкспортаHtmlОбъектов.СетевойКаталог КАК СетевойКаталог,
	|	НастройкиЭкспортаHtmlОбъектов.ПолныйСетевойПуть КАК ПолныйСетевойПуть,
	|	НастройкиЭкспортаHtmlОбъектов.ЧастичныйСетевойПуть КАК ЧастичныйСетевойПуть
	|ИЗ
	|	РегистрСведений.НастройкиЭкспортаHtmlОбъектов КАК НастройкиЭкспортаHtmlОбъектов
	|ГДЕ
	|	НастройкиЭкспортаHtmlОбъектов.HtmlОбъект = &ВидОбъекта";
...
Функция ОпределитьРесурсПоРасширению(Расширение) Экспорт 
	Результат = ПредопределенноеЗначение("Перечисление.ВидыРесурса.Файл");
	...
	Если Изображения.Найти(Расширение) <> Неопределено Тогда
		Результат = ПредопределенноеЗначение("Перечисление.ВидыРесурса.Изображение");
	ИначеЕсли Стили.Найти(Расширение) <> Неопределено Тогда
		Результат = ПредопределенноеЗначение("Перечисление.ВидыРесурса.Стиль");
	ИначеЕсли Скрипты.Найти(Расширение) <> Неопределено Тогда
		Результат = ПредопределенноеЗначение("Перечисление.ВидыРесурса.Скрипт");
	КонецЕсли;
