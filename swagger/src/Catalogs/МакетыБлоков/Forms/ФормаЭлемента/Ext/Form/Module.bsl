...
Процедура УстановитьВидимостьКонструктора(ПриводитьТип = Ложь)
	Если ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.Запрос") Тогда
		...
		Если ПриводитьТип Тогда
			ИсточникДанных = ПредопределенноеЗначение("Справочник.ИсточникДанных.ПустаяСсылка");
		КонецЕсли;
	ИначеЕсли ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.ПростойТекст") Тогда
		...
		КонецЕсли;
	ИначеЕсли ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.Значение") Тогда
	    Элементы.ПараметрыИсточника.Видимость = Ложь;
		Элементы.ИсточникДанных.Видимость = Ложь;
		Элементы.ПодсказкаКод.Видимость = Ложь;
		Если ПриводитьТип Тогда
			ИсточникДанных = Неопределено;
		КонецЕсли;
	ИначеЕсли ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.Объект") Тогда
		Элементы.ПараметрыИсточника.Видимость = Ложь;
		Элементы.ИсточникДанных.Видимость = Истина;
		Элементы.ПодсказкаКод.Видимость = Ложь;
		Если ПриводитьТип Тогда
			ИсточникДанных = Неопределено;
		КонецЕсли;
	ИначеЕсли ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.Список") Тогда
		Элементы.ПараметрыИсточника.Видимость = Ложь;
		Элементы.ИсточникДанных.Видимость = Ложь;
		Элементы.ПодсказкаКод.Видимость = Ложь;
		Если ПриводитьТип Тогда
	...
	ИначеЕсли ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.ЗапросСОбработкойРезультата") Тогда
		...
		Если ПриводитьТип Тогда
			ИсточникДанных = ПредопределенноеЗначение("Справочник.ИсточникДанных.ПустаяСсылка");
		КонецЕсли;
	ИначеЕсли ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.ПроизвольныйКод") Тогда
		Элементы.ПараметрыИсточника.Видимость = Ложь;
		Элементы.ИсточникДанных.Видимость = Ложь;
		Элементы.ПодсказкаКод.Видимость = Истина;
		Если ПриводитьТип Тогда
...
Функция ПолучитьСписокПараметровИсточника()
	...
	Если ВидИсточникаДанных <> ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.Запрос") И ВидИсточникаДанных <> ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.ЗапросСОбработкойРезультата") Тогда
		Возврат Результат;
	КонецЕсли;
	...
	|ИЗ
	|	Справочник.ИсточникДанных.Параметры КАК ИсточникДанныхПараметры
	|ГДЕ
...
Функция ПолучитьСписокПолейИсточника()
	...
	|ИЗ
	|	Справочник.ИсточникДанных.Поля КАК ИсточникДанныхПоля
	|ГДЕ
...
Процедура ПослеВыбораПеременной(РезультатВыбора, ДопПараметры) Экспорт 
	Если РезультатВыбора <> Неопределено Тогда
		Если ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.ЗапросСОбработкойРезультата") Или ВидИсточникаДанных = ПредопределенноеЗначение("Перечисление.ВидыИсточниковДанных.ПроизвольныйКод") Тогда
			Элементы.Текст.ВыделенныйТекст = РезультатВыбора.Значение;
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура ВставитьВхоядщийПараметр(Команда)
