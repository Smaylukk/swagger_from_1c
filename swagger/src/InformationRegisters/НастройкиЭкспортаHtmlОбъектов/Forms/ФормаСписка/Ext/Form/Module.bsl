...
Процедура ЗаполнитьНаСервере()
	НЗ = РегистрыСведений.НастройкиЭкспортаHtmlОбъектов.СоздатьНаборЗаписей();
	НЗ.Очистить();
	НЗ.Записать();
	
	НоваяЗапись = НЗ.Добавить();
	НоваяЗапись.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Изображения");
	
	НоваяЗапись = НЗ.Добавить();
	НоваяЗапись.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Скрипты");
	
	НоваяЗапись = НЗ.Добавить();
	НоваяЗапись.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Стили");
	
	НоваяЗапись = НЗ.Добавить();
	НоваяЗапись.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Файлы");
...
Процедура УстановитьСетевойКаталогНаСервере(Путь)
	МЗ = РегистрыСведений.НастройкиЭкспортаHtmlОбъектов.СоздатьМенеджерЗаписи();
	МЗ.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Изображения");
	МЗ.Прочитать();
	...
	МЗ = РегистрыСведений.НастройкиЭкспортаHtmlОбъектов.СоздатьМенеджерЗаписи();
	МЗ.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Скрипты");
	МЗ.Прочитать();
	Если МЗ.Выбран() Тогда
	...
	МЗ = РегистрыСведений.НастройкиЭкспортаHtmlОбъектов.СоздатьМенеджерЗаписи();
	МЗ.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Стили");
	МЗ.Прочитать();
	Если МЗ.Выбран() Тогда
	...
	МЗ = РегистрыСведений.НастройкиЭкспортаHtmlОбъектов.СоздатьМенеджерЗаписи();
	МЗ.HtmlОбъект = ПредопределенноеЗначение("Перечисление.HTMLОбъекты.Файлы");
	МЗ.Прочитать();
	Если МЗ.Выбран() Тогда
