...
Процедура ОбновитьСоставОбъектов()
	...
	МассивОбъектов.Добавить("Страницы");
	МассивОбъектов.Добавить("Ресурсы");
	МассивОбъектов.Добавить("МакетыБлоков");
	МассивОбъектов.Добавить("ИсточникДанных");
	МассивОбъектов.Добавить("ОтчетыЛичногоКабинета");
	...
	Если ТипЗнч(ПараметрыПеретаскивания.Значение) = Тип("Массив") Тогда
		Для каждого ТекСтрока Из ПараметрыПеретаскивания.Значение Цикл
			Если ТипЗнч(ТекСтрока.Объект) <> Тип("Строка") Тогда
				...
				Если ТипЗнч(ТекОбъект) = Тип("СправочникСсылка.Ресурсы") Тогда
...
Процедура НайтиСвязанныеОбъекты(ТекОбъект, СвязанныеОбъекты)
	Если ТипЗнч(ТекОбъект) = Тип("СправочникСсылка.Страницы") Тогда
		НайтиСвязанныеОбъекты_Страница(ТекОбъект, СвязанныеОбъекты);
	ИначеЕсли ТипЗнч(ТекОбъект) = Тип("СправочникСсылка.Ресурсы") Тогда
		НайтиСвязанныеОбъекты_Ресурс(ТекОбъект, СвязанныеОбъекты);
	ИначеЕсли ТипЗнч(ТекОбъект) = Тип("СправочникСсылка.МакетыБлоков") Тогда
...
Процедура НайтиСвязанныеОбъекты_Страница(ТекОбъект, СвязанныеОбъекты)
	...
	Если Ложь Тогда
		СтраницаОбъект = Справочники.Страницы.СоздатьЭлемент()
	КонецЕсли;
...
Процедура НайтиСвязанныеОбъекты_Ресурс(ТекОбъект, СвязанныеОбъекты)
	...
	Если Ложь Тогда
		РесурсОбъект = Справочники.Ресурсы.СоздатьЭлемент()
	КонецЕсли;
	
	Если РесурсОбъект.ВидРесурса = ПредопределенноеЗначение("Перечисление.ВидыРесурса.Стиль") Или РесурсОбъект.ВидРесурса = ПредопределенноеЗначение("Перечисление.ВидыРесурса.Скрипт") Тогда
...
Процедура НайтиСвязанныеОбъекты_Блок(ТекОбъект, СвязанныеОбъекты)
	...
	Для каждого ТекСтрокаСостава Из БлокОбъект.Состав Цикл
		Если ЗначениеЗаполнено(ТекСтрокаСостава.ИсточникДанных) И ТипЗнч(ТекСтрокаСостава.ИсточникДанных) = Тип("СправочникСсылка.ИсточникДанных") Тогда
